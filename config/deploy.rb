...
# the application.
set :application, "codebook"

# Target directory for the application on the web and app servers.
set :deploy_to, "/home/railsdev/public_html"

# Primary domain name of your application. Used as a default for all server roles.
set :domain, "codebook.wowps.org"
...
# SCM OPTIONS
# =============================================================================
set :scm, :git # :subversion    # :subversion or :git
set :repository, "git@github.com:djravine/codebook.git" 
