...
teButtons.push(new TextileEditorButton('ed_code', 			'link.png','"TEXT":',  '\n', 'l', 'Link'));
teButtons.push(new TextileEditorButton('ed_code', 			'image.png','$i$TITLE|',  '$$', 'i', 'Image'));
teButtons.push(new TextileEditorButton('ed_code', 			'script_code_red.png','@-code-@',  '@@', 'c', 'Code Snippet'));
...
//teButtons.push(new TextileEditorButton('ed_code','image.png','@','@','c','Code'));